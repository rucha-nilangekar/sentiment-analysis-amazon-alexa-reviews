...
def predict():
    ...
    predictor = pickle.load(open(r"Models/models-upsample/model_xgb.pkl", "rb"))
    scaler = pickle.load(open(r"Models/models-upsample/scaler.pkl", "rb"))
    cv = pickle.load(open(r"Models/models-upsample/countVectorizer.pkl", "rb"))
    try:
